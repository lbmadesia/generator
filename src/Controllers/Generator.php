...
class Generator
{
    ...
    {
        //Module
        $this->module = ucfirst($input['name']);

        //Directory
        $this->directory = str_replace(' ' , '', Str::singular(ucfirst($input['directory_name'])));

        //Model
        $this->model = Str::singular(ucfirst($input['model_name']));
    ...
    public function insertToLanguageFiles()
    {
        ...
        $model_singular = ucfirst(Str::singular($this->model));
